...
#Aucune frame n'a encore etait capturer, prevFrame est donc initialise a None
prevFrame = None
...
while True:
    ...
    #On passe l'image en niveau de gris et on luis applique un flou gaussien pour supprimmer le bruit
    ...
    #On fait la difference absolue en l'image actuelle et la precedente
    ...
    for c in contr:
        ...
        #Tous les petit objets sont ignore avec cette ligne
        if cv2.contourArea(c) < 1500:
			continue

        #Recherche des coordonne de l'objet et on adapte le mask en fonction de l'objet
